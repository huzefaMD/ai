...
3. Branding materials available
...
3. Auction items & reserve prices
...
3. A trending audio suggestion (India-appropriate)
...
3. Tone of communication & style guidelines
...
3. Introduce an exclusive offer for a return visit
...
3. Separate sections for venue spaces, décor, catering, and guest experiences 
...
3. Submission guidelines (hashtags, tagging)
...
3. 3 Instagram reel concepts with storyboards
...
3. Collaboration deliverables (stay, content creation, mentions)
...
3. Accommodation + event bundle info
...
3. Outline 4–5 subheadings with summary points
...
3. Add logistical details like ideal travel times, private transfers, and ticketing tips.
...
3. Plan one unique experience per day (sunset cruise, spice plantation, feni tasting, cooking class).
...
3. Interest in adventure activities (Y/N)
...
3. Suggest stays, adventure activities (trekking, paragliding), and best cafés.
...
3. Recommend local experiences like block printing, cooking classes, and folk music nights.
...
3. Add one cultural show experience (Kathakali or Kalaripayattu). 
...
3. Interest in wildlife safaris (Y/N) 
...
3. Suggest centrally located, comfortable hotels.
...
3. Add scuba diving and snorkelling options.
...
3. Interest in adventure water sports (Y/N)
...
3. Add local festivals or cultural events (if applicable).
...
3. Add monastery visits and adventure activities.
...
3. Add a desert camping experience with camel rides.
...
3. Interest in luxury stays (Y/N)
...
3. Plan internal transport (bus/tempo traveller).
...
3. Level of adventure activity comfort
...
3. Plan comfortable transport between cities.
...
3. Level of interest in cultural events (low/medium/high)
...
3. Add local culinary experiences.
...
3. Plan visits to famous ashrams and spiritual centres.
...
3. Interest in Ayurveda treatments (Y/N)
...
3. Add workshops or demonstrations on local crafts.
...
3. Suggest leisurely market visits for spices and handicrafts.
...
3. Add evening Ganga aarti in Varanasi.
...
3. Interest in adventure sports (Y/N)
...
3. Plan local transport using taxis and metro.
...
3. Interest in live theatre (Y/N)
...
3. Suggest a Darjeeling toy train ride.
...
3. Suggest local wildlife viewing spots.
...
3. Interest in night photography (Y/N)
...
3. Diving certification status (Y/N)
...
3. Add local food tasting experiences.
...
3. Plan rest days between journeys.
...
3. Interest in specific train routes
...
3. Offer a concrete solution or improvement plan. 
...
3. Mention measures taken to minimise disruption.
...
3. Details dietary labels and allergens on menu cards.
...
3. Ensures water, power, and waste disposal arrangements.
...
3. Specifies emergency transport arrangements.
...
3. Show delivery timelines for each meal service.
...
3. Details staff uniform and hygiene checks.
...
3. Provides backup staff during peak hours.
...
3. Requests detailed cost breakdown.
...
3. Records guest feedback per dish.
...
3. Provides waterproofing for food storage.
...
3. Identifies wholesale suppliers with better pricing.
...
3. Flags culturally sensitive ingredients.
...
3. Coordinates with NGOs for leftover pickup.
...
3. Includes sample communication templates.
...
3. Includes setup and cleaning buffers.
...
3. Trains staff in allergen awareness and emergency response.
...
3. Maintains backup suppliers for critical items.
...
3. Assigns staging points for deliveries.
...
3. Ensures variety and nutrition for long shifts.
...
3. Standardises portion sizes and presentation.
...
3. Coordinates with caterers for drink pairings.
...
3. Prepares meals in separate prep areas to avoid contamination.
...
3. Flag vendors with repeated issues.
...
3. Analyse ratings to identify improvement areas.
